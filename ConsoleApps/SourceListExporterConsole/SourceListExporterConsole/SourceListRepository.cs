...
namespace SourceListDataExporter
{
    class SourceListDataRepository
    {
        private readonly ConnectionDescriptor cDesc;
        private readonly IDBContext db;
        private readonly ILogService logger;

        public SourceListDataRepository(ILogService logger)
        {
        ...
        public IList<string> GetData(string FunctionId, ref long processId)
        {
            ...
            var result = db.Fetch<String>("GetDataSourceList", args);
