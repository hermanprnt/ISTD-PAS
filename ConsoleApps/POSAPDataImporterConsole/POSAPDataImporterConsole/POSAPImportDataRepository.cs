            ...
            using (SqlConnection conn = new SqlConnection(cDesc.ConnectionString))
            {
                using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(conn))
                {
                    ...
                    try
                    {
                        ...
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE1", "PO_NOTE1");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE2", "PO_NOTE2");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE3", "PO_NOTE3");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE4", "PO_NOTE4");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE5", "PO_NOTE5");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE6", "PO_NOTE6");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE7", "PO_NOTE7");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE8", "PO_NOTE8");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE9", "PO_NOTE9");
                        sqlBulkCopy.ColumnMappings.Add("PO_NOTE10", "PO_NOTE10");
