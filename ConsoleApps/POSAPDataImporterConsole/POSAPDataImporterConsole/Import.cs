        ...
        public static string ReadFiles(ILogService logger, string localLocation, string module, string function)
        {
            ...
            try
            {
                if (listfile != null)
                {
                    ...
                    table.Columns.Add("PO_NOTE1");
                    table.Columns.Add("PO_NOTE2");
                    table.Columns.Add("PO_NOTE3");
                    table.Columns.Add("PO_NOTE4");
                    table.Columns.Add("PO_NOTE5");
                    table.Columns.Add("PO_NOTE6");
                    table.Columns.Add("PO_NOTE7");
                    table.Columns.Add("PO_NOTE8");
                    table.Columns.Add("PO_NOTE9");
                    table.Columns.Add("PO_NOTE10");
                        ...
                        try
                        {
                            ...
                            using (StreamReader reader = new StreamReader(filename))
                            {
                                ...
                                while ((RowData = reader.ReadLine()) != null)
                                {
                                    ...
                                    row["FILE_NO"] = FILE_NO;
                                    row["SEQ_NO"] = SEQ;
                                    row["VENDOR_CD"] = data[2] == "" ? "" : data[2].ToString().Substring(4, 6);//Int64.Parse(data[2]).ToString();
                                    ...
                                    row["SERV_ITEM"] = data[50] == "" ? "" : data[50].Substring((data[50].Length-5), 5);
                                    ...
                                    row["OUT_TYPE"] = data[68];
                                    row["OUT_MESSAGE"] = data[69];
                                    row["CREATED_DT"] = DateTime.Now.Date;
                                    row["CHANGED_BY"] = null;
                                    row["CHANGED_DT"] = null;
                                    if (!String.IsNullOrEmpty(data[55])) row["WBS_NO"] = data[55];

                                    row["PO_NOTE1"] = data[58];
                                    row["PO_NOTE2"] = data[59];
                                    row["PO_NOTE3"] = data[60];
                                    row["PO_NOTE4"] = data[61];
                                    row["PO_NOTE5"] = data[62];
                                    row["PO_NOTE6"] = data[63];
                                    row["PO_NOTE7"] = data[64];
                                    row["PO_NOTE8"] = data[65];
                                    row["PO_NOTE9"] = data[66];
                                    row["PO_NOTE10"] = data[67];
