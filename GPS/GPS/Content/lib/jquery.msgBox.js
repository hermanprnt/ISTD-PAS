...
var msgBoxImagePath = "../../Content/Img/";
...
function msg (options) {
    ...
    $(options.buttons).each(function (index, button) {
        btncolorclass = ((button.value.toLowerCase() == "ok") || (button.value.toLowerCase() == "yes")) ? "btn-primary" : "btn-danger"
        buttons += "<input class=\"msgButton btn " + btncolorclass + "\" type=\"button\" name=\"" + button.value + "\" value=\"" + button.value + "\" />";
    });
