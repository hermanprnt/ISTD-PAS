 ...
 IF OBJECT_ID('tempdb..#temp_search_download_proc_tracking') IS NOT NULL
BEGIN
	DROP TABLE #temp_search_download_proc_tracking
END
 ...
 select  DISTINCT A.PR_NO	
	...
	,	d.VENDOR_CD
	,	d.VENDOR_NAME
	INTO #temp_search_download_proc_tracking
	from 
	TB_R_PR_H A 
