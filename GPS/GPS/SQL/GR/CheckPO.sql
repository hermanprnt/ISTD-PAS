	...
	BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						SELECT TOP 1 @@PO_NO = PO_NO, @@WBS = WBS_NO FROM TB_R_PO_ITEM WHERE PO_NO=@@PO AND ITEM_CLASS='M' -- PO_NO AND WBS
						IF EXISTS (SELECT WBS_NO FROM TB_M_WBS_CARRYOVER WHERE WBS_NO = @@WBS)
						BEGIN
