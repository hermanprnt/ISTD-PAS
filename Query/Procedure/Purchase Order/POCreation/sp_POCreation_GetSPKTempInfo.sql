CREATE PROCEDURE [dbo].[sp_POCreation_GetSPKTempInfo]
    @processId BIGINT
AS
BEGIN
    SELECT
	...
	ISNULL(REPLACE(SPK_PARAGRAPH1, '<br/>', '[enter]'), (SELECT MAIL_BODY FROM TB_M_CONTENT WHERE FUNCTION_ID = '302001' AND CONTENT_ID = '01')) Opening,
    SPK_WORK_DESC Work,
